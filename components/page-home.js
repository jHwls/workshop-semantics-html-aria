					...
					<div className="wide-layout two-part-overlap">
						<div className="content-block-wrap">
							...
							<div className="content-block">
								...
								<p>
									By researching places, accomodations, and activities that
									match your lifestyle, you can have the time of your life.
								</p>
							</div>
						</div>
						<div className="link-block">
							...
							<ul className="link-list">
								...
								<li>
									<a href="#">
										<span aria-hidden="true"></span>Texas
									</a>
								</li>
								<li>
									<a href="#">
										<span aria-hidden="true"></span>Utah
									</a>
								</li>
								<li>
									<a href="#">
										<span aria-hidden="true"></span>Oregon
									</a>
								</li>
								<li>
									<a href="#">
										<span aria-hidden="true"></span>Alaska
									</a>
								</li>
								<li>
									<a href="#">
										<span aria-hidden="true"></span>Hawaii
									</a>
								</li>
							</ul>
						</div>
